...
const demoNodeExecutions = [
  ...
  { id: "40000000-0000-0000-0000-000000000014", run_id: RUN_IDS.run5, node_id: "step-1", status: "completed", started_at: iso(6.98), completed_at: iso(6.95), prompt_tokens: 450, completion_tokens: 120, total_tokens: 570, estimated_cost_usd: 0.0018, billed_cost_usd: 0.018, connector_api_calls: 0, model_call_count: 1, stored_full_prompt: false, stored_full_input: false, stored_full_output: false },
