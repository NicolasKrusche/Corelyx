...
export const providerRegistry: Provider[] = [
  ...
  },
  {
    ...
    name: "OpenRouter",
    category: "llm",
    purpose: "Optional routing layer for customer-selected model providers.",
    default_region: "Provider-managed; EU routing is enterprise or account-configuration dependent.",
    available_regions: ["Provider-managed global routing", "EU routing for eligible configurations"],
    eu_only_supported: true,
    ...
    dpa_available: false,
    scc_available: false,
    transfer_basis: "Customer must verify DPA, SCCs, EU routing, and downstream provider policy before production personal-data use.",
    subprocessor_url: "https://openrouter.ai/privacy",
    privacy_url: "https://openrouter.ai/privacy",
    retention_notes: "Retention depends on OpenRouter account settings and downstream model provider settings.",
    last_reviewed_at: LAST_PROVIDER_REVIEWED_AT,
    status: "blocked",
    optional: true,
    used_by_default: false,
  ...
  },
  {
    ...
    name: "Google",
    category: "connector",
    purpose: "Google Sign-In and optional Gmail, Calendar, Docs, Drive, and Sheets workflow actions.",
    ...
    eu_only_supported: true,
    data_categories_processed: ["Profile data", "Mailbox and file metadata", "Message and document content", "Calendar data", "Workflow payloads"],
    personal_data_allowed: true,
    stores_prompts: false,
    stores_outputs: false,
    trains_on_customer_data: false,
    ...
    retention_notes: "Retention is controlled by the connected Google account or tenant.",
    last_reviewed_at: LAST_PROVIDER_REVIEWED_AT,
    status: "customer_configured",
    optional: true,
    used_by_default: false,
  ...
  },
  {
    ...
    name: "Microsoft",
    category: "connector",
    purpose: "Optional Outlook, Microsoft 365, OneDrive, and Teams workflow actions.",
    default_region: "Provider-managed; depends on Microsoft tenant settings.",
    available_regions: ["Customer tenant settings", "Provider-managed global infrastructure"],
    eu_only_supported: true,
    data_categories_processed: ["Mailbox data", "File metadata and content", "Teams data", "User and tenant metadata"],
    personal_data_allowed: true,
    stores_prompts: false,
    stores_outputs: false,
    trains_on_customer_data: false,
    dpa_available: true,
    scc_available: true,
    transfer_basis: "Microsoft DPA, SCCs, and customer tenant region controls.",
    subprocessor_url: "https://servicetrust.microsoft.com/ViewPage/MSComplianceGuideV3",
    privacy_url: "https://privacy.microsoft.com/privacystatement",
    retention_notes: "Retention is controlled by the connected Microsoft tenant.",
    last_reviewed_at: LAST_PROVIDER_REVIEWED_AT,
    status: "customer_configured",
    optional: true,
    used_by_default: false,
  ...
  },
  {
    ...
    name: "Slack",
    category: "connector",
    purpose: "Optional Slack messages, channel actions, and event workflows.",
    default_region: "Provider-managed; depends on Slack workspace plan and settings.",
    available_regions: ["Provider-managed global infrastructure", "Slack data residency options for eligible workspaces"],
    eu_only_supported: true,
    data_categories_processed: ["Workspace metadata", "Channel metadata", "Message content", "Workflow payloads"],
    personal_data_allowed: true,
    stores_prompts: false,
    stores_outputs: false,
    trains_on_customer_data: false,
    dpa_available: true,
    scc_available: true,
    transfer_basis: "Slack DPA, SCCs, and customer workspace residency settings.",
    subprocessor_url: "https://slack.com/subprocessors",
    privacy_url: "https://slack.com/privacy-policy",
    retention_notes: "Retention is controlled by the connected Slack workspace.",
    last_reviewed_at: LAST_PROVIDER_REVIEWED_AT,
    status: "customer_configured",
    optional: true,
    used_by_default: false,
