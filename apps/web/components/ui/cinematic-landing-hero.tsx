...
const INJECTED_STYLES = `
  ...
  /* Deep Physical Card with Dynamic Mouse Lighting (Corelyx brand orange tint) */
  .premium-depth-card {
      background: linear-gradient(145deg, #2a1408 0%, #0A101D 100%);
      box-shadow:
...
export function CinematicHero({
  brandName = "Corelyx",
  tagline1 = "Automate the busywork,",
  tagline2 = "trust every step.",
  cardHeading = "Automation you can trust.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">Corelyx</span> turns a
      plain-language request into a validated workflow you can see, review, and
      run — with humans in the loop wherever it matters.
    </>
  ),
  metricValue = 94,
  metricLabel = "Success rate",
  ctaHeading = "Automate your first workflow.",
  ctaDescription = "Describe it in a sentence, review the plan, and run it — with humans in the loop where it counts. Free plan, no credit card.",
  className,
  ...props
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // GPU-accelerate transforms for smoother scrubbing.
      gsap.defaults({ force3D: true });

      gsap.set(".text-track", { autoAlpha: 0, y: 60, scale: 0.85, filter: "blur(10px)", rotationX: -20 });
      gsap.set(".text-days", { autoAlpha: 1, clipPath: "inset(0 100% 0 0)" });
      gsap.set(".main-card", { y: window.innerHeight + 200, autoAlpha: 1 });
      gsap.set([".card-left-text", ".card-right-text", ".mockup-scroll-wrapper", ".floating-badge", ".phone-widget"], { autoAlpha: 0 });
      gsap.set(".cta-wrapper", { autoAlpha: 0, scale: 0.8, filter: "blur(16px)" });
      ...
      scrollTl
        .to([".hero-text-wrapper", ".bg-grid-theme"], { scale: 1.15, filter: "blur(8px)", opacity: 0.2, ease: "power2.inOut", duration: 2 }, 0)
  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform [transform-style:preserve-3d]">
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <Link href="/signup" aria-label="Start for free" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-[#f05a28] focus:ring-offset-2">
            <Sparkles className="w-7 h-7 transition-transform group-hover:scale-105 text-[#f05a28]" aria-hidden="true" />
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Get started</div>
              <div className="text-xl font-bold leading-none tracking-tight">Start for free</div>
            </div>
          </Link>
          <Link href="/pricing" aria-label="View pricing" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-[#f05a28] focus:ring-offset-2 focus:ring-offset-background">
            <ArrowRight className="w-7 h-7 transition-transform group-hover:translate-x-0.5" aria-hidden="true" />
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Plans from €0</div>
              <div className="text-xl font-bold leading-none tracking-tight">View pricing</div>
            </div>
          </Link>
        </div>
      </div>
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                <div
                  ref={mockupRef}
                  className="relative w-[280px] h-[580px] rounded-[3rem] iphone-bezel flex flex-col will-change-transform [transform-style:preserve-3d]"
                >
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Workflows</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">CX</div>
                      </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
                          ...
                          <circle className="progress-ring" cx="88" cy="88" r="64" fill="none" stroke="#f05a28" strokeWidth="12" />
                        </svg>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500/20 to-orange-600/5 flex items-center justify-center mr-3 border border-orange-400/20 shadow-inner">
                            <Workflow className="w-4 h-4 text-orange-400 drop-shadow-md" aria-hidden="true" />
                          </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Run complete</p>
                    <p className="text-orange-200/50 text-[10px] lg:text-xs font-medium">11 / 14 steps</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-emerald-500/20 to-emerald-900/10 flex items-center justify-center border border-emerald-400/30 shadow-inner">
                    <ShieldCheck className="w-4 h-4 lg:w-5 lg:h-5 text-emerald-300 drop-shadow-lg" aria-hidden="true" />
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">EU-hosted</p>
                    <p className="text-emerald-200/50 text-[10px] lg:text-xs font-medium">Credentials secured</p>
                  </div>
                </div>
