...
const OG_DESCRIPTION =
  "Corelyx is the AI automation platform that helps you inventory, classify, document, audit, review, and govern your AI workflows for GDPR and EU AI Act readiness.";
