  ...
  return (
    <div className="max-w-3xl space-y-0">
      ...
      <Section
        ...
        description="Download all your programs (full workflow schemas and version history) plus connection and API-key metadata as JSON. Credentials are never included."
      >
        <a
          href="/api/export"
          download
          className="inline-flex items-center gap-2 rounded-lg border glass-card px-4 py-2.5 text-sm font-medium hover:bg-accent transition-colors"
        >
          ...
          Download all workflows &amp; data (JSON)
        </a>
      </Section>
