  ...
  const PLANS = [
    {
      ...
      href: tier === "plus" ? undefined : currentTierIdx > 1 ? "/plan" : undefined,
      primary: false,
      current: tier === "plus",
    ...
    },
    {
      ...
      features: [
        ...
        "500 runs / month",
        "60,000 platform AI credits / month",
        "90-day run history",
        "All trigger types",
        "Priority support",
      ],
      ...
      href: tier === "pro" ? undefined : currentTierIdx > 2 ? "/plan" : undefined,
      primary: true,
      current: tier === "pro",
      badge: "MOST POPULAR",
    },
    {
      ...
      features: [
        ...
        "2,000 runs / month",
        "150,000 platform AI credits / month",
        "1-year run history",
      ...
      cta: tier === "builder" ? "Current plan" : "Upgrade to Scale",
      checkout: currentTierIdx <= 2 ? { tier: "builder", interval: "month" } as const : undefined,
      href: tier === "builder" ? undefined : "/plan",
      primary: false,
