...
export async function GET(request: Request) {
  ...
  const label = typeof payload.label === "string" && payload.label.trim() ? payload.label : "confluence:primary";
  ...
  return redirectWithClearedOAuthState(`${origin}/connections?connected=confluence`, flowId);
}
