...
export async function GET(request: Request) {
  ...
  const label = typeof payload.label === "string" && payload.label.trim() ? payload.label : "jira:primary";
  ...
  return redirectWithClearedOAuthState(`${origin}/connections?connected=jira`, flowId);
}
