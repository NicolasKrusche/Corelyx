...
export async function GET(request: Request) {
  ...
  const label = typeof payload.label === "string" && payload.label.trim() ? payload.label : "monday:primary";
  ...
  return redirectWithClearedOAuthState(`${origin}/connections?connected=monday`, flowId);
}
