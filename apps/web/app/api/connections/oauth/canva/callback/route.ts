...
export async function GET(request: Request) {
  ...
  const label = typeof payload.label === "string" && payload.label.trim() ? payload.label : "canva:primary";
  ...
  return redirectWithClearedOAuthState(`${origin}/connections?connected=canva`, flowId);
}
