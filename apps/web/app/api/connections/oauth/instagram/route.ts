...
const SCOPES = ["instagram_basic", "instagram_content_publish", "instagram_manage_insights", "pages_show_list"].join(" ");
...
export async function GET(request: Request) {
  ...
  const label = searchParams.get("label") ?? "instagram:primary";
