...
export async function GET(request: Request) {
  ...
  const label = typeof payload.label === "string" && payload.label.trim() ? payload.label : "zohocrm:primary";
  ...
  return redirectWithClearedOAuthState(`${origin}/connections?connected=zohocrm`, flowId);
}
