...
class StoryblokConnector(IConnector):
    ...
    provider = "storyblok"
    supported_operations = ["list_stories", "create_story"]
    ...
    async def _list_stories(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
    ...
    async def _create_story(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
