...
_BASE = "https://api.crisp.com/v1"


class CrispConnector(IConnector):
    """
    Crisp connector for: list_conversations, get_conversation.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Crisp does not support '{operation}'",
                    )
    ...
    async def _get_conversation(
        ...
        r = await request_with_rate_limit(
            client, "POST", f"{_BASE}/get_conversation",
