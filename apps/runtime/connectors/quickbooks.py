...
_BASE = "https://api.quickbooks.com/v1"


class QuickbooksConnector(IConnector):
    """
    QuickBooks connector for: list_invoices, create_invoice.

    API Base: quickbooks
    """

    provider = "quickbooks"
    supported_operations = ["list_invoices", "create_invoice"]
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"QuickBooks does not support '{operation}'",
                    )
    ...
    async def _create_invoice(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
