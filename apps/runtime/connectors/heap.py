...
_BASE = "https://api.heap.com/v1"


class HeapConnector(IConnector):
    """
    Heap connector for: list_users, get_user.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Heap does not support '{operation}'",
                    )
