...
_BASE = "https://api.zendesk.com/v1"


class ZendeskConnector(IConnector):
    """
    Zendesk connector for: list_tickets, create_ticket.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Zendesk does not support '{operation}'",
                    )
