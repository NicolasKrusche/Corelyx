...
_BASE = "https://api.harvest.com/v1"


class HarvestConnector(IConnector):
    """
    Harvest connector for: list_time_entries, create_time_entry.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Harvest does not support '{operation}'",
                    )
