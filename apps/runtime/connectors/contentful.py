...
class ContentfulConnector(IConnector):
    ...
    provider = "contentful"
    supported_operations = ["list_entries", "get_entry"]
    ...
    async def _list_entries(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
    ...
    async def _get_entry(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
