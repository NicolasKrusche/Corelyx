...
class NetsuiteConnector(IConnector):
    ...
    provider = "netsuite"
    supported_operations = ["query_records", "create_record"]
    ...
    async def _query_records(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
        """Execute query_records operation."""
        r = await request_with_rate_limit(
            client,
            "POST",
            f"{_BASE}/query_records",
            headers=headers,
            json=params or {},
        )
