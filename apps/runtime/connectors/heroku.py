...
class HerokuConnector(IConnector):
    ...
    provider = "heroku"
    supported_operations = ["list_apps", "get_app"]
    ...
    async def _list_apps(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
    ...
    async def _get_app(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
