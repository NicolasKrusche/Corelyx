...
_BASE = "https://api.okta.com/v1"


class OktaConnector(IConnector):
    """
    Okta connector for: list_users, get_user.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Okta does not support '{operation}'",
                    )
