...
class DigitaloceanConnector(IConnector):
    ...
    supported_operations = ["list_droplets", "create_droplet"]
    ...
    async def _list_droplets(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
    ...
    async def _create_droplet(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
