...
_BASE = "https://api.freshdesk.com/v1"


class FreshdeskConnector(IConnector):
    """
    Freshdesk connector for: list_tickets, create_ticket.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Freshdesk does not support '{operation}'",
                    )
