...
_BASE = "https://api.box.com/v1"


class BoxConnector(IConnector):
    """
    Box connector for: list_files, get_file.

    API Base: box
    """

    provider = "box"
    supported_operations = ["list_files", "get_file"]
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Box does not support '{operation}'",
                    )
