...
_BASE = "https://api.mollie.com/v1"


class MollieConnector(IConnector):
    """
    Mollie connector for: list_payments, create_payment.

    API Base: mollie
    """

    provider = "mollie"
    supported_operations = ["list_payments", "create_payment"]
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Mollie does not support '{operation}'",
                    )
    ...
    async def _create_payment(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
