...
class CanvaConnector(IConnector):
    ...
    provider = "canva"
    supported_operations = ["list_designs", "get_design"]
    ...
    async def _list_designs(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
    ...
    async def _get_design(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
