...
_BASE = "https://api.tally.com/v1"


class TallyConnector(IConnector):
    """
    Tally connector for: list_forms, get_responses.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Tally does not support '{operation}'",
                    )
