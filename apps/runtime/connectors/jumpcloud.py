...
_BASE = "https://api.jumpcloud.com/v1"


class JumpcloudConnector(IConnector):
    """
    JumpCloud connector for: list_users, get_user.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"JumpCloud does not support '{operation}'",
                    )
