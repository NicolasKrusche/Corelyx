...
class HotjarConnector(IConnector):
    ...
    provider = "hotjar"
    supported_operations = ["list_heatmaps", "get_heatmap"]
    ...
    async def _list_heatmaps(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
    ...
    async def _get_heatmap(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
