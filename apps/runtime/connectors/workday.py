...
class WorkdayConnector(IConnector):
    ...
    provider = "workday"
    supported_operations = ["list_workers", "get_worker"]
    ...
    async def _list_workers(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
    ...
    async def _get_worker(self, client: httpx.AsyncClient, headers: dict, params: dict) -> dict:
