...
_BASE = "https://api.toggl.com/v1"


class TogglConnector(IConnector):
    """
    Toggl connector for: list_time_entries, create_time_entry.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Toggl does not support '{operation}'",
                    )
    ...
    async def _create_time_entry(
        ...
        r = await request_with_rate_limit(
            client, "POST", f"{_BASE}/time_entry",
