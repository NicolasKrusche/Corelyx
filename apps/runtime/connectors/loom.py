...
_BASE = "https://api.loom.com/v1"


class LoomConnector(IConnector):
    """
    Loom connector for: list_videos, get_video.

    API Base: loom
    """

    provider = "loom"
    supported_operations = ["list_videos", "get_video"]
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Loom does not support '{operation}'",
                    )
