...
_BASE = "https://api.gorgias.com/v1"


class GorgiasConnector(IConnector):
    """
    Gorgias connector for: list_tickets, create_ticket.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"Gorgias does not support '{operation}'",
                    )
