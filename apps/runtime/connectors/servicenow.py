...
_BASE = "https://api.servicenow.com/v1"


class ServicenowConnector(IConnector):
    """
    ServiceNow connector for: list_incidents, create_incident.
            ...
            match operation:
                ...
                case _:
                    raise ConnectorError(
                        ...
                        f"ServiceNow does not support '{operation}'",
                    )
